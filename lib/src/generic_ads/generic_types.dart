...
typedef DSOnPaidEventCallback = void Function(DSAd ad, double valueMicros,
    PrecisionType precision, String currencyCode, String? appLovinDspName);
typedef DSOnAdFailedToLoad = void Function(
    DSAd ad, int errCode, String errDescription);
typedef DSOnRewardEventCallback = void Function(
    DSAd ad, num amount, String type);
...
//  set onAdFailedToLoad(void Function(DSInterstitialAd ad, int errCode, String errText) value);
  ...
  set onAdFailedToShow(
      void Function(DSInterstitialAd ad, int errCode, String errText) value);
...
abstract class DSNativeAd extends DSAd {
  ...
  final void Function(DSNativeAd ad, int errCode, String errDescription)?
      onAdFailedToLoad;
  final void Function(DSNativeAd ad)? onAdClicked;
  final void Function(DSNativeAd ad, double valueMicros,
      DSPrecisionType precision, String currencyCode) onPaidEvent;
...
//  set onAdFailedToLoad(void Function(DSRewardedAd ad, int errCode, String errText) value);
  ...
  set onAdFailedToShow(
      void Function(DSRewardedAd ad, int errCode, String errText) value);
...
//  set onAdFailedToLoad(void Function(DSAppOpenAd ad, int errCode, String errText) value);
  ...
  set onAdFailedToShow(
      void Function(DSAppOpenAd ad, int errCode, String errText) value);
